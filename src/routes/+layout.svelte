...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
	...
	<div class="fixed inset-0 opacity-20">
		<div class="absolute inset-0" style="background-image: radial-gradient(circle at 25px 25px, rgba(255,255,255,.1) 2px, transparent 0), radial-gradient(circle at 75px 75px, rgba(255,255,255,.05) 2px, transparent 0); background-size: 100px 100px;"></div>
	</div>
	...
	>
		...
		{#if pageLoading}
					{#if showLoadingBar}
			<div class="fixed top-16 left-0 right-0 h-1 bg-gradient-to-r from-purple-500 via-cyan-500 to-purple-500 animate-pulse z-50"></div>
		{/if}
		{/if}
				...
				<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
					...
					<div class="space-y-4">
						...
						<div class="flex space-x-4">
							<button type="button" class="text-gray-400 hover:text-white transition-colors duration-200">
